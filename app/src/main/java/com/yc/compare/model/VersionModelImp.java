...
import com.yc.compare.api.VersionServiceApi;
...
public class VersionModelImp extends BaseModel implements VersionModel<VersionInfoRet> {
    ...
    @Override
    public void checkVersion(final IBaseRequestCallBack iBaseRequestCallBack) {
        RequestBody requestBody = RequestBody.create(MediaType.parse("application/json"), "");
        mCompositeSubscription.add(versionServiceApi.checkVersion(requestBody)  //将subscribe添加到subscription，用于注销subscribe
